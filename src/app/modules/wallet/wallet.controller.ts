...
const addMoney = catchAsync(async (req: Request, res: Response) => {
    ...
    // Record transaction
    await TransactionService.recordAddMoneyTransaction(userId, amount);
...
const withdrawMoney = catchAsync(async (req: Request, res: Response) => {
    ...
    // Record transaction
    await TransactionService.recordWithdrawTransaction(userId, amount);
...
const sendMoney = catchAsync(async (req: Request, res: Response) => {
    ...
    // Record transactions
    await TransactionService.recordSendMoneyTransaction(senderId, receiverId, amount);
    await TransactionService.recordReceiveMoneyTransaction(senderId, receiverId, amount);
...
const cashIn = catchAsync(async (req: Request, res: Response) => {
    ...
    // Record transaction
    await TransactionService.recordCashInTransaction(agentId, userId, amount, commission);
...
const cashOut = catchAsync(async (req: Request, res: Response) => {
    ...
    // Record transaction
    await TransactionService.recordCashOutTransaction(agentId, userId, amount, commission);
